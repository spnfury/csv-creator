    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full h-96 px-4 py-3 text-base border-2 border-red-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 font-mono resize-y"
                ...
                <div>
                    ...
                    <Tabs value={outputType} onValueChange={setOutputType} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 bg-red-100">
                            <TabsTrigger value="html" className="data-[state=active]:bg-red-600 data-[state=active]:text-white">HTML</TabsTrigger>
                            <TabsTrigger value="mediawiki" className="data-[state=active]:bg-red-600 data-[state=active]:text-white">MediaWiki</TabsTrigger>
                        </TabsList>
            ...
            <div className="mt-8">
                ...
                <div className="p-4 border-2 border-dashed border-red-200 rounded-xl bg-red-50 min-h-[10rem]">
