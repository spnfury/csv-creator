        ...
        >
            ...
            <div className="bg-red-50 rounded-xl p-6 border-2 border-red-200">
                ...
                <pre className="text-lg font-mono bg-white p-4 rounded-lg border-2 border-red-200 overflow-x-auto">
                 ...
                 <p className="mt-4 text-lg text-gray-700">Para este ejemplo, los anchos de columna serían: <code className="bg-red-200 text-red-800 font-bold px-2 py-1 rounded">10, 10, 10</code></p>
            </div>
        </motion.div>
    );
}
