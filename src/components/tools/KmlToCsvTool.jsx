            ...
            >
                ...
                <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-200">
                    ...
                    <pre className="text-lg font-mono bg-white p-4 rounded-lg border-2 border-blue-200 overflow-x-auto">
                     ...
                     <p className="mt-4 text-lg text-gray-700">La herramienta extrae datos de los elementos <code className="bg-blue-200 text-blue-800 font-bold px-2 py-1 rounded">&lt;Placemark&gt;</code>.</p>
                </div>
            </motion.div>
        );
    }
